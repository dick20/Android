...
CREATE TABLE `hero_equip` (
  ...
  `equip_ids1` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `tips1` text CHARACTER SET utf8,
  `equip_ids2` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `tips2` text CHARACTER SET utf8,
  PRIMARY KEY (`hero_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='英雄推荐装备';

-- ----------------------------
-- Records of hero_equip
-- ----------------------------
INSERT INTO `hero_equip` VALUES ('105', '1331,1334,1421,1333,1327,1337', '这是全肉装坦克的出装方法，团战技能有一定输出能力，也有非常强的承伤能力', '1331,1334,1421,13310,1336,1335', '对方物理输出较多情况下，极寒风暴能降低敌方输出的攻击速度，魔女斗篷配合被动能有更大的收益');
